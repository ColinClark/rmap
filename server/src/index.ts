...
app.use('*', logger())
app.use('*', cors({
  origin: ['http://localhost:3000', 'http://localhost:3001', 'http://localhost:5173', 'http://monster.local:3000', 'http://monster.local:3001', 'http://app.truepop.ai', 'https://app.truepop.ai', 'https://*.yourdomain.com'],
  credentials: true,
}))
